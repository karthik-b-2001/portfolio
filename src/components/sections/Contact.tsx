  ...
  return (
    <section id="contact" className="py-20 bg-white dark:bg-gray-800">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-gray-800 dark:text-white mb-12 text-center">Contact Me</h2>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mt-12 text-center">
            <p className="text-gray-600 dark:text-gray-400">Or reach out directly:</p>
            <a
